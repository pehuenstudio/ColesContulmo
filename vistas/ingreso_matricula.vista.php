...
<link rel="stylesheet" href="/_code/vistas/css/_ingreso_matricula.css">
...
<script src="/_code/vistas/js/_ingreso_matricula.js"></script>
    ...
    <div id="matricula_formulario">
        <div class="contenedor">
            <div id="modulo_matriculas">
                ...
                <section>
                    <?php require_once $_SERVER["DOCUMENT_ROOT"]."/_code/vistas/ingreso_matricula.alumno.php";?>
                </section>
                <h2>Ingreso De Apoderado</h2>
                <section>
                    <?php require_once $_SERVER["DOCUMENT_ROOT"]."/_code/vistas/ingreso_matricula.apoderado.php";?>
                </section>

                <h2>Seleccionar Curso</h2>
                <section>
                    <?php require_once $_SERVER["DOCUMENT_ROOT"]."/_code/vistas/ingreso_matricula.curso.php";?>
                </section>

                <h2>Resumen</h2>
                <section>
                    <?php require_once $_SERVER["DOCUMENT_ROOT"]."/_code/vistas/ingreso_matricula.resumen.php";?>
                </section>
            </div>
        </div>
    </div>
