...
function ingresar_alumno(formData){
    var resultado = false;
    jQuery.ajax({
        async: false,
        url: "/_code/controladores/matricula.ingreso.alumno.php",
        type: 'POST',
        data: formData,
        contentType: false,
        cache: false,
        ...
        .done(function(data){
            ...
            setTimeout(function(){
                jQuery("#load_ingreso_alumno").html("<img class='load2' src="+icon+">");
                jQuery("#msg_ingreso_alumno").removeClass()
                    .addClass(clase)
                    .html(msg);
                jQuery("#load_ingreso_sistema1_label").text("Ingresando alumno en el sistema…");
                jQuery("#load_ingreso_sistema1").html("<img class='load2' src='/_code/vistas/img/load2.gif'>");
        ...
        .fail(function(jqXHR, textStatus){
           mostrar_dialogo(0,"Se a producido un error fatal.");
           jQuery("#load_ingreso_alumno").html("<img class='load2' src='/_code/vistas/img/no-ok.png'>");
        })
        .always(function(){
...
function ingresar_alumno_sistema(formData){
    var resultado = false;
    jQuery.ajax({
        async: false,
        url: "/_code/controladores/matricula.ingreso.alumno.joomla.php",
        type: 'POST',
        data: formData,
        contentType: false,
        cache: false,
        ...
        .fail(function(jqXHR, textStatus){
            mostrar_dialogo(0,"Se a producido un error fatal.");
            jQuery("#load_ingreso_sistema1").html("<img class='load2' src='/_code/vistas/img/no-ok.png'>");
        })
        .always(function(){
...
function ingresar_apoderado(formData){
    var resultado = false;
    jQuery.ajax({
        async: false,
        url: "/_code/controladores/matricula.ingreso.apoderado.php",
        type: 'POST',
        data: formData,
        contentType: false,
        cache: false,
        ...
        .done(function(data){
            ...
            setTimeout(function(){
                jQuery("#load_ingreso_apoderado").html("<img class='load2' src="+icon+">");
                jQuery("#msg_ingreso_apoderado").removeClass()
                    .addClass(clase)
                    .html(msg);
                jQuery("#load_ingreso_sistema2_label").text("Ingresando apoderado en el sistema…");
                jQuery("#load_ingreso_sistema2").html("<img class='load2' src='/_code/vistas/img/load2.gif'>");
            },3000);
        ...
        .fail(function(jqXHR, textStatus){
            mostrar_dialogo(0,"Se a producido un error fatal.");
            jQuery("#load_ingreso_apoderado").html("<img class='load2' src='/_code/vistas/img/no-ok.png'>");
        })
        .always(function(){
...
function ingresar_apoderado_sistema(formData){
    var resultado = false;
    jQuery.ajax({
        async: false,
        url: "/_code/controladores/matricula.ingreso.apoderado.joomla.php",
        type: 'POST',
        data: formData,
        contentType: false,
        cache: false,
        ...
        .done(function(data){
            ...
            setTimeout(function(){
                jQuery("#load_ingreso_sistema2").html("<img class='load2' src="+icon+">");
                jQuery("#msg_ingreso_sistema2").removeClass()
                    .addClass(clase)
                    .html(msg);
                jQuery("#load_ingreso_matricula_label").text("Guardando matricula…");
                jQuery("#load_ingreso_matricula").html("<img class='load2' src='/_code/vistas/img/load2.gif'>");
            },4000);

        })
        .fail(function(jqXHR, textStatus){
            mostrar_dialogo(0,"Se a producido un error fatal.");
            jQuery("#load_ingreso_sistema2").html("<img class='load2' src='/_code/vistas/img/no-ok.png'>");
        })
        .always(function(){
...
function ingresar_matricula(formData){
    var resultado = false;
    jQuery.ajax({
        async: false,
        url: "/_code/controladores/matricula.ingreso.curso.php",
        type: 'POST',
        data: formData,
        contentType: false,
        cache: false,
        ...
        .done(function(data){
            ...
            setTimeout(function(){
                jQuery("#load_ingreso_matricula").html("<img class='load2' src="+icon+">");
                jQuery("#msg_ingreso_matricula").removeClass()
                    .addClass(clase)
                    .html(msg);
        ...
        .fail(function(jqXHR, textStatus){
            mostrar_dialogo(0,"Se a producido un error fatal.");
            jQuery("#load_ingreso_matricula").html("<img class='load2' src='/_code/vistas/img/no-ok.png'>");
        })
        .always(function(){
