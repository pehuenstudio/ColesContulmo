<table border="1px">
    ...
    <tr id="grados_repetidos">
        <td>&nbsp;</td>
        <td><input type="checkbox" data-id_grado="4" data-id_tipo_ensenanza="10"></td>
        <td><input type="checkbox" data-id_grado="5" data-id_tipo_ensenanza="10"></td>
        <td><input type="checkbox" data-id_grado="1" data-id_tipo_ensenanza="110"></td>
        <td><input type="checkbox" data-id_grado="2" data-id_tipo_ensenanza="110"></td>
        <td><input type="checkbox" data-id_grado="3" data-id_tipo_ensenanza="110"></td>
        <td><input type="checkbox" data-id_grado="4" data-id_tipo_ensenanza="110"></td>
        <td><input type="checkbox" data-id_grado="5" data-id_tipo_ensenanza="110"></td>
        <td><input type="checkbox" data-id_grado="6" data-id_tipo_ensenanza="110"></td>
