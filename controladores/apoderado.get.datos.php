...
switch ($funcion){
    case 1:
        ...
        $apoderado_array["direccion_id"]["id_comuna"] = $direccion->get_id_comuna();
        $apoderado_array["direccion_id"]["id_provincia"] = $direccion->get_id_provincia();
        $apoderado_array["direccion_id"]["id_region"] = $direccion->get_id_region();

        $apoderado_array["direccion_nombre"]["nombre_comuna"] = $direccion->get_nombre_comuna();
        $apoderado_array["direccion_nombre"]["nombre_provincia"] = $direccion->get_nombre_provincia();
        $apoderado_array["direccion_nombre"]["nombre_region"] = $direccion->get_nombre_region();
