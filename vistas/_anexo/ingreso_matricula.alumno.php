...
<div id="contenedor_alumno">
    <div class="contenedor_grillas">
        ...
        <input type="hidden" name="id_direccion_alumno" id="id_direccion_alumno">
        <div class="grilla5 derecha">
        ...
        <div class="grilla5 izquierda">
            ...
            <div class="grilla10">
            <?php require_once $_SERVER["DOCUMENT_ROOT"]."/_code/vistas/_anexo/ingreso_matricula.repeticiones.php"?>
