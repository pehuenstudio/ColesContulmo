...
<form id="matricula_formulario">
    <div class="contenedor_grillas">
        <div class="grilla5 izquierda">
            ...
            <div class="grilla10 error">aquierror</div>
            <div class="grilla10">Fecha De Nacimiento</div>
            <div class="grilla10"> <input type="date"></div>
            <div class="grilla10 error">aquierror</div>
            <div class="grilla1"><input type="checkbox"></div><div class="grilla9">&#191;Problemas De Aprendizaje? </div>
            <div class="grilla10 error">aquierror</div>
        ...
        <div class="grilla5 izquierda">
            <div class="grilla10">Grado Educacional Del Padre</div>
            <div class="grilla10"><select></select></div>
            <div class="grilla10 error">aquierror</div>
        </div>
        <div class="grilla5 derecha">
            <div class="grilla10">Grado Educacional De La Madre</div>
            <div class="grilla10"><select></select></div>
            <div class="grilla10 error">aquierror</div>
        </div>
        <div class="grilla10">Persona Con Quien Vive</div>
        <div class="grilla10"><input type="text"></div>
        <div class="grilla10 error">aquierror</div>
  	</div>
</form>